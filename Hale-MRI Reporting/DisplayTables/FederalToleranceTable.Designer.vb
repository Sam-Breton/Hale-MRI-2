...
Partial Class FederalToleranceTable
    ...
    Private Sub InitializeComponent()
        ...
        tlayoutFedtol.RowStyles.Add(New RowStyle(SizeType.Percent, 14.3F))
        tlayoutFedtol.RowStyles.Add(New RowStyle(SizeType.Percent, 85.7F))
        tlayoutFedtol.Size = New Size(496, 196)
        ...
        tlayoutrealfedtol.Location = New Point(0, 28)
        ...
        tlayoutrealfedtol.RowStyles.Add(New RowStyle(SizeType.Percent, 16.666666F))
        tlayoutrealfedtol.RowStyles.Add(New RowStyle(SizeType.Percent, 16.666666F))
        tlayoutrealfedtol.Size = New Size(496, 168)
        ...
        LabPAPHighLow.Location = New Point(375, 109)
        LabPAPHighLow.Margin = New Padding(5, 0, 5, 0)
        LabPAPHighLow.Name = "LabPAPHighLow"
        LabPAPHighLow.Size = New Size(115, 26)
        ...
        LabPAPDiff.Location = New Point(252, 109)
        LabPAPDiff.Margin = New Padding(5, 0, 5, 0)
        LabPAPDiff.Name = "LabPAPDiff"
        LabPAPDiff.Size = New Size(112, 26)
        ...
        LabPAPPerc.Location = New Point(129, 109)
        LabPAPPerc.Margin = New Padding(5, 0, 5, 0)
        LabPAPPerc.Name = "LabPAPPerc"
        LabPAPPerc.Size = New Size(112, 26)
        LabPAPPerc.TabIndex = 17
        LabPAPPerc.Text = "0.75 %"
        ...
        LabPAP.Location = New Point(6, 109)
        LabPAP.Margin = New Padding(5, 0, 5, 0)
        LabPAP.Name = "LabPAP"
        LabPAP.Size = New Size(112, 26)
        LabPAP.TabIndex = 16
        ...
        LabBAPHighLow.Location = New Point(375, 82)
        LabBAPHighLow.Margin = New Padding(5, 0, 5, 0)
        LabBAPHighLow.Name = "LabBAPHighLow"
        LabBAPHighLow.Size = New Size(115, 26)
        ...
        LabBAPDiff.Location = New Point(252, 82)
        LabBAPDiff.Margin = New Padding(5, 0, 5, 0)
        LabBAPDiff.Name = "LabBAPDiff"
        LabBAPDiff.Size = New Size(112, 26)
        ...
        LabBAPPerc.Location = New Point(129, 82)
        LabBAPPerc.Margin = New Padding(5, 0, 5, 0)
        LabBAPPerc.Name = "LabBAPPerc"
        LabBAPPerc.Size = New Size(112, 26)
        ...
        LabBAP.Location = New Point(6, 82)
        LabBAP.Margin = New Padding(5, 0, 5, 0)
        LabBAP.Name = "LabBAP"
        LabBAP.Size = New Size(112, 26)
        LabBAP.TabIndex = 12
        ...
        LabSPHighLow.Location = New Point(375, 55)
        LabSPHighLow.Margin = New Padding(5, 0, 5, 0)
        LabSPHighLow.Name = "LabSPHighLow"
        LabSPHighLow.Size = New Size(115, 26)
        ...
        ' LabSPDiff
        ' 
        LabSPDiff.Location = New Point(252, 55)
        LabSPDiff.Margin = New Padding(5, 0, 5, 0)
        LabSPDiff.Name = "LabSPDiff"
        LabSPDiff.Size = New Size(112, 26)
        ...
        LabSPPerc.Location = New Point(129, 55)
        LabSPPerc.Margin = New Padding(5, 0, 5, 0)
        LabSPPerc.Name = "LabSPPerc"
        LabSPPerc.Size = New Size(112, 26)
        ...
        LabSP.Location = New Point(6, 55)
        LabSP.Margin = New Padding(5, 0, 5, 0)
        LabSP.Name = "LabSP"
        LabSP.Size = New Size(112, 26)
        LabSP.TabIndex = 8
        ...
        LabLPHighLow.Location = New Point(375, 28)
        LabLPHighLow.Margin = New Padding(5, 0, 5, 0)
        LabLPHighLow.Name = "LabLPHighLow"
        LabLPHighLow.Size = New Size(115, 26)
        ...
        LabLPDiff.Location = New Point(252, 28)
        LabLPDiff.Margin = New Padding(5, 0, 5, 0)
        LabLPDiff.Name = "LabLPDiff"
        LabLPDiff.Size = New Size(112, 26)
        ...
        LabLPPerc.Location = New Point(129, 28)
        LabLPPerc.Margin = New Padding(5, 0, 5, 0)
        LabLPPerc.Name = "LabLPPerc"
        LabLPPerc.Size = New Size(112, 26)
        ...
        LabLP.Location = New Point(6, 28)
        LabLP.Margin = New Padding(5, 0, 5, 0)
        LabLP.Name = "LabLP"
        LabLP.Size = New Size(112, 26)
        LabLP.TabIndex = 4
        ...
        LabRadHighLow.Location = New Point(375, 1)
        LabRadHighLow.Margin = New Padding(5, 0, 5, 0)
        LabRadHighLow.Name = "LabRadHighLow"
        LabRadHighLow.Size = New Size(115, 26)
        ...
        LabRadDiff.Location = New Point(252, 1)
        LabRadDiff.Margin = New Padding(5, 0, 5, 0)
        LabRadDiff.Name = "LabRadDiff"
        LabRadDiff.Size = New Size(112, 26)
        ...
        LabRadPerc.Location = New Point(129, 1)
        LabRadPerc.Margin = New Padding(5, 0, 5, 0)
        LabRadPerc.Name = "LabRadPerc"
        LabRadPerc.Size = New Size(112, 26)
        ...
        LabRadius.Size = New Size(112, 26)
        ...
        LabTrackDiff.Location = New Point(252, 136)
        LabTrackDiff.Margin = New Padding(5, 0, 5, 0)
        LabTrackDiff.Name = "LabTrackDiff"
        LabTrackDiff.Size = New Size(112, 31)
        ...
        LabTrack.Location = New Point(4, 136)
        LabTrack.Name = "LabTrack"
        LabTrack.Size = New Size(116, 31)
        ...
        LabTitle.Size = New Size(486, 28)
        LabTitle.TabIndex = 1
        LabTitle.Text = "Federal Tolerance"
        LabTitle.TextAlign = ContentAlignment.MiddleLeft
        ' 
        ' FederalToleranceTable
        ' 
